package com.kaliram.sms.controller;
...
public class StudentController {
	...
	public String listStudents(Model model) {
		model.addAttribute("students", studentService.getAllStudent());//key value pair (we retrieve all student from db)
		return "students";
	}
	...
	public String createStudentForm(Model model) {
		...
		model.addAttribute("student",student);//adding student model and emplty obj ref
